...
class User(Base):
    ...
    phone      = Column(String(15), unique=True, nullable=True)   # naya field
    ...
    is_verified        = Column(Boolean, default=False)   # overall: kam se kam ek channel verified ho
    is_email_verified  = Column(Boolean, default=False)
    is_phone_verified  = Column(Boolean, default=False)
    otp_code           = Column(String(10), nullable=True)
    otp_expires_at     = Column(DateTime, nullable=True)
    otp_channel        = Column(String(10), nullable=True)  # "email" ya "phone" — pending OTP kaha gaya
...
class Campaign(Base):
    ...
    # ── NAYA: Targeting Suggestion feature ke liye company details ──
    company_name     = Column(String(200), nullable=True)
    company_email    = Column(String(200), nullable=True)
    company_phone    = Column(String(20),  nullable=True)
    company_pincode  = Column(String(10),  nullable=True)  # Website Traffic/Brand Awareness ka destination URL
